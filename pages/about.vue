      ...
      <main class="isolate">
            ...
            >
              ...
              >
                <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <h1
                    class="text-4xl font-semibold tracking-tight text-primary-900 sm:text-6xl"
                  >
                    Wir haben die Lösungen für Ihre IT
                  </h1>
                  <p
                    class="relative mt-6 text-xl leading-8 text-secondary-600 sm:max-w-md lg:max-w-none"
                  >
                    Willkommen bei der GIM Gesellschaft für integratives
                    Management mbH, Ihrem kompetenten Partner für
                    IT-Infrastruktur, Managed Services und SAP Basis
                    Dienstleistungen. Unser Unternehmen wurde gegründet, um
                    gezielt die Bedürfnisse von Mittelständlern zu erfüllen, die
                    häufig mit Herausforderungen wie begrenzten Budgets und
                    knappen Ressourcen konfrontiert sind.
                  </p>
                </div>
                <div
        ...
        <div class="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
          <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            <h2
              class="text-3xl font-bold tracking-tight text-primary-900 sm:text-4xl"
            >
              Unsere Mission
            </h2>
            <div class="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
              <div class="lg:w-full lg:max-w-2xl lg:flex-auto">
                <p class="text-xl leading-8 text-secondary-600">
                  Wir sind bestrebt, persönliche und individuelle Beratung zu
                  bieten und Unternehmen dabei zu helfen, ihre IT-Prozesse zu
                  implementieren, ihre Digitalisierung Prozess zu beschleunigen
                  damit Sie das Potenzial ihrer Digitalen Ressourcen voll
                  auszuschöpfen.
                </p>
                <div
                  class="mt-10 max-w-xl text-base leading-7 text-secondary-700 text-l"
                >
                  <p>
                    Unsere Aufgabe bei der GIM Gruppe ist es, KMUs durch die
                    Optimierung ihrer IT-Infrastruktur und digitalen Prozesse zu
                    unterstützen. Die IT ist ein Grundbestandteil ihre
                    Unternehmenstrategie damit alles reibungslos funktioniert.
                  </p>
                  <p class="mt-10">
                    Unser Ziel ist es, Managed Services und SAP-Basis-Services
                    anzubieten, die speziell auf die Bedürfnisse jedes einzelnen
                    Kunden zugeschnitten sind.
                  </p>
                  <p class="mt-10">
                    Durch den Einsatz neuester Technologien und unseres
                    Expertenwissens sorgen wir dafür, dass die Systeme unserer
                    Kunden stets aktuell, effizient und zuverlässig sind und
                    bleiben.
                  </p>
                </div>
              </div>
        ...
        <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-0">
            <h2
              class="text-3xl font-semibold tracking-tight text-primary-900 sm:text-4xl"
            >
              Wir sind die IT-Kompetenz
            </h2>
            <p class="mt-6 text-lg leading-8 text-secondary-600">
              Sechs Gründe für unser Unternehmen.
            </p>
          </div>
          <dl
          ...
          >
            <div v-for="value in values" :key="value.name">
              <dt class="font-semibold text-primary-900">{{ value.name }}</dt>
