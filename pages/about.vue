...
const team = [
  {
    ...
    role: 'CEO',
    imageUrl:
      'https://avatar.iran.liara.run/public/boy?username=Lutz',
  },
  {
    name: 'Jonas Grossen',
    role: 'CTO',
    imageUrl:
      'https://avatar.iran.liara.run/public/boy?username=Jonas',
  },
  {
    name: 'Sven Schmidt',
    role: 'CIO',
    imageUrl:
      'https://avatar.iran.liara.run/public/boy?username=Sven',
  },
  {
  ...
  },
  {
    ...
    role: 'VP SAP-Basis',
    imageUrl:
      'https://avatar.iran.liara.run/public/boy?username=Sebastian',
  },
  {
    name: 'Tony Tu',
    role: 'IT-Consultant Infrastruktur und Entwicklung',
    imageUrl:
      'https://avatar.iran.liara.run/public/boy?username=Tony',
  },
  {
    name: 'Beata Schaffelke',
    role: 'Buchhaltung',
    imageUrl:
      'https://avatar.iran.liara.run/public/girl?username=Beata',
  },
  {
    name: 'Isabella Krämer',
    role: 'SAP Consulting',
    imageUrl:
      'https://avatar.iran.liara.run/public/girl?username=Isa',
  },
  // More people...
]
const blogPosts = [
    ...
    <main class="isolate">
      ...
      <div class="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
        <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
          <h2 class="text-3xl font-bold tracking-tight text-primary-900 sm:text-4xl">Unsere Mission</h2>
          <div class="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
            <div class="lg:w-full lg:max-w-2xl lg:flex-auto">
              ...
              <div class="mt-10 max-w-xl text-base leading-7 text-secondary-700 text-l">
                ...
                <p class="mt-10">
                  Durch den Einsatz neuester Technologien und unseres Expertenwissens sorgen wir dafür, dass die Systeme unserer Kunden stets aktuell, effizient und zuverlässig sind und bleiben.</p>
              </div>
            </div>
      ...
      <div class="mt-32 sm:mt-40 xl:mx-auto xl:max-w-7xl xl:px-8">
        <img src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" class="aspect-[5/2] w-full object-cover xl:rounded-3xl" />
      </div>

      <!-- Values section -->
      <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          <h2 class="text-3xl font-semibold tracking-tight text-primary-900 sm:text-4xl">Wir sind die IT-Kompetenz</h2>
          <p class="mt-6 text-lg leading-8 text-secondary-600">Sechs Gründe für unser Unternehmen.</p>
        </div>
